    ...
    def set_embeddings_weights(self, model_embeddings_weights, predict_special_tokens=True):
        ...
        if self.torchscript:
            self.decoder.weight = nn.Parameter(
                model_embeddings_weights.clone())
        else:
...
class OpenAIGPTPreTrainedModel(PreTrainedModel):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *inputs, **kwargs):
        ...
        model = super(OpenAIGPTPreTrainedModel, cls).from_pretrained(
            pretrained_model_name_or_path, pretrained_model_name_or_path, *inputs, **kwargs)
...
class OpenAIGPTLMHeadModel(OpenAIGPTPreTrainedModel):
    ...
    def set_num_special_tokens(self, num_special_tokens, predict_special_tokens=True):
        ...
        self.lm_head.set_embeddings_weights(
            self.transformer.tokens_embed.weight, predict_special_tokens=predict_special_tokens)
