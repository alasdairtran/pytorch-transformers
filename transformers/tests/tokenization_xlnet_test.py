...
from transformers.tokenization_xlnet import (PRETRAINED_VOCAB_ARCHIVE_MAP,
                                             SPIECE_UNDERLINE, XLNetTokenizer)
...
class XLNetTokenizationTest(unittest.TestCase):
    ...
    def test_full_tokenizer(self):
        ...
        self.assertListEqual(tokens, [SPIECE_UNDERLINE + u'I', SPIECE_UNDERLINE + u'was', SPIECE_UNDERLINE + u'b',
                                      ...
                                      u'9', u'2', u'0', u'0', u'0', u',', SPIECE_UNDERLINE +
                                      u'and', SPIECE_UNDERLINE + u'this',
